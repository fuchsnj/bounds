...
fn test_intersection() {
    ...
    assert!(!Bounds::range(Bound::exclusive(1), Bound::inclusive(3))
        .intersects(&Bounds::range(Bound::exclusive(3), Bound::exclusive(5))));

    assert!(Bounds::range(Bound::exclusive(1), Bound::inclusive(3))
        .intersects(&Bounds::range(Bound::inclusive(3), Bound::exclusive(5))));
...
fn test_compare() {
    assert_eq!(
        Bounds::from(1..3).compare_to(&Bounds::from(2..4)),
        Comparison::Intersects
    );
    assert_eq!(
        Bounds::from(2..3).compare_to(&Bounds::from(0..2)),
        Comparison::Greater
    );
    assert_eq!(
        Bounds::from(0..2).compare_to(&Bounds::from(2..3)),
        Comparison::Less
    );
    assert_eq!(
        Bounds::Exact(2).compare_to(&Bounds::from(3..4)),
        Comparison::Less
    );
    assert_eq!(
        Bounds::from(3..4).compare_to(&Bounds::Exact(2)),
        Comparison::Greater
    );
}
...
fn test_merge() {
    assert_eq!(
        Bounds::from(1..3).merge(Bounds::Exact(2)),
        Bounds::from(1..3)
    );
    assert_eq!(
        Bounds::from(1..3).merge(Bounds::Exact(1)),
        Bounds::from(1..3)
    );
    assert_eq!(
        Bounds::from(1..3).merge(Bounds::Exact(3)),
        Bounds::Range(Some(Bound::inclusive(1)), Some(Bound::inclusive(3)))
    );
    assert_eq!(
        Bounds::from(1..3).merge(Bounds::Exact(0)),
        Bounds::Range(Some(Bound::inclusive(0)), Some(Bound::exclusive(3)))
    );
    assert_eq!(
        Bounds::from(1..3).merge(Bounds::Exact(4)),
        Bounds::Range(Some(Bound::inclusive(1)), Some(Bound::inclusive(4)))
    );

    assert_eq!(
        Bounds::from(1..4).merge(Bounds::from(2..3)),
        Bounds::from(1..4)
    );
    assert_eq!(
        Bounds::from(1..4).merge(Bounds::from(0..2)),
        Bounds::from(0..4)
    );
    assert_eq!(
        Bounds::from(1..4).merge(Bounds::from(3..5)),
        Bounds::from(1..5)
    );
    assert_eq!(
...
fn test_neg() {
    assert_eq!(
        -Bounds::from(1..3),
        Bounds::Range(Some(Bound::exclusive(-3)), Some(Bound::inclusive(-1)))
    );
    assert_eq!(-Bounds::Exact(2), Bounds::Exact(-2));
    assert_eq!(
        -Bounds::from(1..),
        Bounds::Range(None, Some(Bound::inclusive(-1)))
    );
    assert_eq!(
        -Bounds::from(..2),
...
fn test_mul() {
    ...
    assert_eq!(
        Bounds::Exact(-1) * Bounds::from(2..),
        Bounds::Range(None, Some(Bound::inclusive(-2)))
    );
    assert_eq!(
        Bounds::Exact(-1) * Bounds::from(..2),
        Bounds::Range(Some(Bound::exclusive(-2)), None)
    ...
    assert_eq!(
        Bounds::<i32>::Range(None, None) * Bounds::Range(None, None),
        Bounds::Range(None, None)
    );
    assert_eq!(
        Bounds::Range(None, None) * Bounds::from(1..2),
        Bounds::Range(None, None)
    );
    assert_eq!(Bounds::from(1..2) * Bounds::from(..), Bounds::from(..));
    assert_eq!(
        Bounds::Exact(-1) * Bounds::from(1..),
        Bounds::Range(None, Some(Bound::inclusive(-1)))
    );
...
fn test_div() {
    ...
    assert_eq!(
        Bounds::from(2..) / Bounds::Exact(2),
        Some(Bounds::from(1..))
    );
    assert_eq!(
        Bounds::from(2..) / Bounds::Exact(-2),
        Some(Bounds::Range(None, Some(Bound::inclusive(-1))))
    );
    assert_eq!(
        Bounds::from(-2..) / Bounds::Exact(2),
        Some(Bounds::from(-1..))
    ...
    assert_eq!(
        Bounds::from(..2) / Bounds::Exact(-2),
        Some(Bounds::Range(Some(Bound::exclusive(-1)), None))
    );
    assert_eq!(
        Bounds::from(..-2) / Bounds::Exact(2),
        Some(Bounds::from(..-1))
    ...
    assert_eq!(
        Bounds::Exact(0) / Bounds::from(1..2),
        Some(Bounds::Exact(0))
    );
    assert_eq!(
    ...
    assert_eq!(
        Bounds::Exact(-6) / Bounds::from(-3..-2),
        Some(Bounds::from(2..3))
    );
    assert_eq!(
        Bounds::Exact(6) / Bounds::from(2..),
        Some(Bounds::Range(None, Some(Bound::inclusive(3))))
    );
    assert_eq!(Bounds::Exact(6) / Bounds::from(-2..), None);
    assert_eq!(Bounds::Exact(6) / Bounds::from(..2), None);
    assert_eq!(
        Bounds::Exact(6) / Bounds::from(..-2),
        Some(Bounds::Range(Some(Bound::exclusive(-3)), None))
    );
    ...
    assert_eq!(
        Bounds::Exact(2) / Bounds::Range(Some(Bound::exclusive(0)), Some(Bound::inclusive(1))),
        Some(Bounds::from(2..))
    );
    assert_eq!(
        Bounds::Exact(-2) / Bounds::Range(Some(Bound::exclusive(0)), Some(Bound::inclusive(1))),
    ...
    assert_eq!(
        Bounds::Exact(2) / Bounds::Range(Some(Bound::exclusive(0)), None),
    ...
    assert_eq!(
        Bounds::Exact(0) / Bounds::Range(Some(Bound::exclusive(0)), None),
        Some(Bounds::Exact(0))
    );
    assert_eq!(
        Bounds::Exact(2) / Bounds::from(-1..0),
        Some(Bounds::Range(None, Some(Bound::inclusive(-2))))
    );
    assert_eq!(
        Bounds::Exact(-2) / Bounds::from(-1..0),
